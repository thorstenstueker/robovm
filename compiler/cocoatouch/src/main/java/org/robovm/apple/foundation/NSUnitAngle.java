...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/NSUnitAngle/*</name>*/ 
    ...
    public NSUnitAngle(String symbol, NSUnitConverter converter) { super(symbol, converter); }
    @Method(selector = "initWithSymbol:")
    public NSUnitAngle(String symbol) { super(symbol); }
    /*</constructors>*/
    /*<properties>*/
    @Property(selector = "degrees")
    public static native NSUnitAngle getDegrees();
    @Property(selector = "arcMinutes")
    public static native NSUnitAngle getArcMinutes();
    @Property(selector = "arcSeconds")
    public static native NSUnitAngle getArcSeconds();
    @Property(selector = "radians")
    public static native NSUnitAngle getRadians();
    @Property(selector = "gradians")
