...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/CIRAWFilter/*</name>*/ 
    ...
    public native NSProgress downloadResourcesWithTimeout$completionHandler$(double timeout, @Block VoidBlock1<NSError> completionHandler);
    /**
     * @since Available in iOS 27.0 and later.
     */
    @Method(selector = "supportedCameraModelsWithVersion:")
    public static native NSArray<NSString> supportedCameraModelsWithVersion(CIRAWDecoderVersion version);
