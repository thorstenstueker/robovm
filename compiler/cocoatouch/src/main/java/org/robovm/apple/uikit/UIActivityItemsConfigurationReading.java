...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/UIActivityItemsConfigurationReading/*</name>*/ 
    ...
    NSObject activityItemsConfigurationMetadataForKey(UIActivityItemsConfigurationMetadataKey key);
    @Method(selector = "activityItemsConfigurationMetadataForItemAtIndex:key:")
    NSObject getItem(@MachineSizedSInt long index, UIActivityItemsConfigurationMetadataKey key);
    @Method(selector = "activityItemsConfigurationPreviewForItemAtIndex:intent:suggestedSize:")
    NSItemProvider getPreview(@MachineSizedSInt long index, UIActivityItemsConfigurationPreviewIntent intent, @ByVal CGSize suggestedSize);
    /*</methods>*/
    /*<adapter>*/
    /*</adapter>*/
}
