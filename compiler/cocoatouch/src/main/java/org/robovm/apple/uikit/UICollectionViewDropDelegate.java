...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/UICollectionViewDropDelegate/*</name>*/ 
    ...
    void performDrop(UICollectionView collectionView, UICollectionViewDropCoordinator coordinator);
    @Method(selector = "collectionView:canHandleDropSession:")
    boolean canHandleDropSession(UICollectionView collectionView, UIDropSession session);
    @Method(selector = "collectionView:dropSessionDidEnter:")
    void dropSessionDidEnter(UICollectionView collectionView, UIDropSession session);
    ...
    void dropSessionDidExit(UICollectionView collectionView, UIDropSession session);
    @Method(selector = "collectionView:dropSessionDidEnd:")
    void dropSessionDidEnd(UICollectionView collectionView, UIDropSession session);
