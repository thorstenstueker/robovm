...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/CIWarpKernel/*</name>*/ 
    ...
    public static CIWarpKernel create(String name, NSData data) throws NSErrorException {
       NSError.NSErrorPtr ptr = new NSError.NSErrorPtr();
       CIWarpKernel result = create(name, data, ptr);
       if (ptr.get() != null) { throw new NSErrorException(ptr.get()); }
       return result;
    }
    /**
    ...
    private static native CIWarpKernel create(String name, NSData data, NSError.NSErrorPtr error);
    /**
     * @since Available in iOS 11.0 and later.
     */
    public static CIWarpKernel create(String name, NSData data, int format) throws NSErrorException {
       NSError.NSErrorPtr ptr = new NSError.NSErrorPtr();
       CIWarpKernel result = create(name, data, format, ptr);
       if (ptr.get() != null) { throw new NSErrorException(ptr.get()); }
       return result;
    }
    /**
    ...
    private static native CIWarpKernel create(String name, NSData data, int format, NSError.NSErrorPtr error);
    /**
